...
ALTER DATABASE RequalDB SET EMERGENCY;
GO

ALTER DATABASE RequalDB set single_user ;
GO

DBCC CHECKDB (RequalDB, REPAIR_ALLOW_DATA_LOSS) WITH ALL_ERRORMSGS ;
GO
...
EXEC sp_detach_db 'RequalDB' ;

EXEC sp_attach_single_file_db @DBName = 'RequalDB', @physname = N'[mdf path]'