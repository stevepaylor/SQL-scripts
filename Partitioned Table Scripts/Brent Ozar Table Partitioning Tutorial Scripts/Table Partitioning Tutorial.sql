...
--Create the partition function: quarterlyPF
DECLARE @StartDate DATE = '20190101';
--PRINT @StartDate ;
CREATE PARTITION FUNCTION quarterlyPF (DATETIME2(0))
AS RANGE RIGHT FOR VALUES
(@StartDate
, DATEADD(QUARTER,1,@StartDate)
, DATEADD(QUARTER,2,@StartDate)
, DATEADD(QUARTER,3,@StartDate)
, DATEADD(QUARTER,4,@StartDate)
, DATEADD(QUARTER,5,@StartDate)
, DATEADD(QUARTER,6,@StartDate)
, DATEADD(QUARTER,7,@StartDate)
, DATEADD(QUARTER,8,@StartDate)
, DATEADD(QUARTER,9,@StartDate)
, DATEADD(QUARTER,10,@StartDate)
, DATEADD(QUARTER,11,@StartDate)
, DATEADD(QUARTER,12,@StartDate)
, DATEADD(QUARTER,13,@StartDate)
) ;
GO
...
ALTER DATABASE PartitionThis ADD FILEGROUP QuarterlyFG01
GO
ALTER DATABASE PartitionThis ADD FILEGROUP QuarterlyFG02
GO
ALTER DATABASE PartitionThis ADD FILEGROUP QuarterlyFG03
GO
ALTER DATABASE PartitionThis ADD FILEGROUP QuarterlyFG04
GO 
ALTER DATABASE PartitionThis ADD FILEGROUP QuarterlyFG05
GO
ALTER DATABASE PartitionThis ADD FILEGROUP QuarterlyFG06
GO
ALTER DATABASE PartitionThis ADD FILEGROUP QuarterlyFG07
GO
ALTER DATABASE PartitionThis ADD FILEGROUP QuarterlyFG08
GO
ALTER DATABASE PartitionThis ADD FILEGROUP QuarterlyFG09
GO
ALTER DATABASE PartitionThis ADD FILEGROUP QuarterlyFG10
GO 
ALTER DATABASE PartitionThis ADD FILEGROUP QuarterlyFG11
GO
ALTER DATABASE PartitionThis ADD FILEGROUP QuarterlyFG12
GO
ALTER DATABASE PartitionThis ADD FILEGROUP QuarterlyFG13
GO
...
WHILE @i <= 13
BEGIN
	SET @sql=N'ALTER DATABASE PartitionThis ADD FILE (name=QuarterlyF' + CAST(@i AS NCHAR(1))+', 
