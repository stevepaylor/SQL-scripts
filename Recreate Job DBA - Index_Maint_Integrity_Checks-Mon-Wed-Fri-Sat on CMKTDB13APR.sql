...
/****** Object:  Job [DBA - Index_Maint_Integrity_Checks-Mon-Wed-Fri-Sat]    Script Date: 3/31/2023 3:08:00 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 3/31/2023 3:08:00 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DBA - Index_Maint_Integrity_Checks-Mon-Wed-Fri-Sat', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Index Optimize All Databases]    Script Date: 3/31/2023 3:08:00 PM ******/
...
, @LogToTable = ''Y''', 
		...
		@flags=4
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Integrity_Checks]    Script Date: 3/31/2023 3:08:00 PM ******/
...
, @LogToTable = ''Y''', 
		...
		@flags=4
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Run Defrag Report]    Script Date: 3/31/2023 3:08:00 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Mon-Wed-Fri-Sat at 2AM', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=106, 
		@freq_subday_type=1, 
		...
		@active_start_date=20210710, 
		@active_end_date=99991231, 
		@active_start_time=20000, 
		@active_end_time=235959, 
		@schedule_uid=N'4f5558a0-a9e9-4c3c-97e4-c445c3793634'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Mon-Wed-Fri-Sat at 6AM', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=106, 
		@freq_subday_type=1, 
		...
		@freq_relative_interval=0, 
		@freq_recurrence_factor=1, 
		@active_start_date=20230328, 
		@active_end_date=99991231, 
		@active_start_time=60000, 
		@active_end_time=235959, 
		@schedule_uid=N'87fc46c9-b249-4627-8075-031d39099352'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
