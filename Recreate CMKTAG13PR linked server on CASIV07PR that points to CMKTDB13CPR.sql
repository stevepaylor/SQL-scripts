...
/****** Object:  LinkedServer [CMKTAG13PR]    Script Date: 3/14/2017 3:45:22 PM ******/
EXEC master.dbo.sp_addlinkedserver @server = N'CMKTAG13PR', @srvproduct=N'', @provider=N'SQLNCLI10', @datasrc=N'CMKTDB13CPR'
