...
/****** Object:  Job [ASPState_Job_DeleteExpiredSessions]    Script Date: 2/19/2016 1:39:18 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 2/19/2016 1:39:18 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [ASPState_JobStep_DeleteExpiredSessions]    Script Date: 2/19/2016 1:39:18 PM ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'ASPState_JobSchedule_DeleteExpiredSessions', 
		...
		@schedule_uid=N'aa9266b0-ce40-4762-8664-4af2b4ada8ce'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
