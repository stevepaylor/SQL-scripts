...
BEGIN
    ...
    BEGIN
         ...
         IF @TheObjectType = 'U'
		 PRINT 'DROP TABLE IF EXISTS [deprecated].[' + @TheObjectName + ']'

         IF @TheObjectType = 'D'
		 PRINT 'DROP DEFAULT IF EXISTS [deprecated].[' + @TheObjectName + ']'

		 IF @TheObjectType = 'V'
		 PRINT 'DROP VIEW IF EXISTS [deprecated].[' + @TheObjectName + ']'

		 IF @TheObjectType = 'P'
		 PRINT 'DROP PROCEDURE IF EXISTS [deprecated].[' + @TheObjectName + ']'
