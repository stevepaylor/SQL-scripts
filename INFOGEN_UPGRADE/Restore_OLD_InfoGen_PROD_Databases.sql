 -- RESTORE ON CASIDB24Apr\INFOGEN
...
----WITH  
----  FILE = 1
----, MOVE N'ig_auditdataData' TO N'K:\UserDBdata\ig_auditdata_data.mdf'
----, MOVE N'ig_auditdataLog'  TO N'L:\UserDBlog\ig_auditdata_log.ldf'
----, NOUNLOAD
----, REPLACE
----, STATS = 5
----GO
...
----WITH  
----  FILE = 1
------, MOVE N'ig_managedsoftwareData' TO N'K:\UserDBdata\ig_managedsoftware_data.mdf'
------, MOVE N'ig_managedsoftwareLog'  TO N'L:\UserDBlog\ig_managedsoftware_log.ldf'
----, NOUNLOAD
----, REPLACE
----, STATS = 5
----GO
...
------WITH  
------  FILE = 1
------, MOVE N'ig_transformData' TO N'K:\UserDBdata\ig_transform_data.mdf'
------, MOVE N'ig_transformLog'  TO N'L:\UserDBlog\ig_transform_log.ldf'
------, NOUNLOAD
------, REPLACE
------, STATS = 5
------GO
