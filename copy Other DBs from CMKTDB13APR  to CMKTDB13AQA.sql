...
--TO  DISK = N'\\CMKTDB13BPR\SQLBackup\CMKTCRYPTO.bak' 
--WITH 
--  NOFORMAT
--, INIT
--, COPY_ONLY
...
TO  DISK = N'\\CMKTDB13BPR\SQLBackup\CMP_RATING.bak' 
WITH 
  NOFORMAT
, INIT
, COPY_ONLY
...
TO  DISK = N'\\CMKTDB13BPR\SQLBackup\dbInfogenesis.bak' 
WITH 
  NOFORMAT
, INIT
, COPY_ONLY
...
TO  DISK = N'\\CMKTDB13BPR\SQLBackup\PrintManager.bak' 
WITH 
  NOFORMAT
, INIT
, COPY_ONLY
...
TO  DISK = N'\\CMKTDB13BPR\SQLBackup\TV13.bak' 
WITH 
  NOFORMAT
, INIT
, COPY_ONLY
...
TO  DISK = N'\\CMKTDB13BPR\SQLBackup\TVAlert13.bak' 
WITH 
  NOFORMAT
, INIT
, COPY_ONLY
...
TO  DISK = N'\\CMKTDB13BPR\SQLBackup\ZipCodes.bak' 
WITH 
  NOFORMAT
, INIT
, COPY_ONLY
