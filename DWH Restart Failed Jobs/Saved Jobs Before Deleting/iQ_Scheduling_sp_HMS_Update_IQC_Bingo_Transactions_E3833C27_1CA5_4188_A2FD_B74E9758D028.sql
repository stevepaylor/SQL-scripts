...
/****** Object:  Job [iQ_Scheduling_sp_HMS_Update_IQC_Bingo_Transactions_E3833C27_1CA5_4188_A2FD_B74E9758D028]    Script Date: 1/3/2023 4:32:15 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 1/3/2023 4:32:15 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'iQ_Scheduling_sp_HMS_Update_IQC_Bingo_Transactions_E3833C27_1CA5_4188_A2FD_B74E9758D028', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Parallel_Execution_Command_1]    Script Date: 1/3/2023 4:32:15 PM ******/
...
BEGIN TRY
    SET @SQL = ''Exec [iQ-Gaming].[VCR].[sp_HMS_Update_IQC_Bingo_Transactions] '';
...
BEGIN  
    ...
    BEGIN
        ...
        SELECT ''sp_HMS_Update_IQC_Bingo_Transactions'', 50, @Start_Dt, @IsError, @Message, @SQL
    END 
END 
ELSE 
BEGIN  
