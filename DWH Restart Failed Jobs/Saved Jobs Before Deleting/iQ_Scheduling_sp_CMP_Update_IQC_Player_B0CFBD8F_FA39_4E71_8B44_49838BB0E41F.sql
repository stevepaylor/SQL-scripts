...
/****** Object:  Job [iQ_Scheduling_sp_CMP_Update_IQC_Player_B0CFBD8F_FA39_4E71_8B44_49838BB0E41F]    Script Date: 1/3/2023 4:25:33 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 1/3/2023 4:25:33 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'iQ_Scheduling_sp_CMP_Update_IQC_Player_B0CFBD8F_FA39_4E71_8B44_49838BB0E41F', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Parallel_Execution_Command_1]    Script Date: 1/3/2023 4:25:33 PM ******/
...
BEGIN  
    ...
    BEGIN
        ...
        SELECT ''sp_CMP_Update_IQC_Player'', 15, @Start_Dt, @IsError, @Message, @SQL
    END 
END 
ELSE 
BEGIN  
