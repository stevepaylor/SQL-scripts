...
/****** Object:  Job [iQ_Scheduling_SDS_iQC_8876B656_5D3F_446A_A66D_48802FF982EC]    Script Date: 1/3/2023 4:23:44 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 1/3/2023 4:23:44 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'iQ_Scheduling_SDS_iQC_8876B656_5D3F_446A_A66D_48802FF982EC', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Parallel_Execution_Command_1]    Script Date: 1/3/2023 4:23:44 PM ******/
...
BEGIN TRY
    SET @SQL = ''Exec [dbo].[sp_Flow_Runner] ''''SDS_iQC'''', ''''D'''' '';
...
BEGIN  
    ...
    BEGIN
        ...
        SELECT ''SDS_iQC'', 8, @Start_Dt, @IsError, @Message, @SQL
    END 
END 
ELSE 
BEGIN  
