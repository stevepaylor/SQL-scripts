...
/****** Object:  Job [iQ_Scheduling_sp_CMP_Update_IQC_Player_Points_60CBA796_F7A2_4CCF_A5C6_DD4837CFFDD3]    Script Date: 1/3/2023 4:26:58 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 1/3/2023 4:26:58 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'iQ_Scheduling_sp_CMP_Update_IQC_Player_Points_60CBA796_F7A2_4CCF_A5C6_DD4837CFFDD3', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Parallel_Execution_Command_1]    Script Date: 1/3/2023 4:26:58 PM ******/
...
BEGIN TRY
    SET @SQL = ''Exec [iQ-Gaming].[VCR].[sp_CMP_Update_IQC_Player_Points] D'';
...
BEGIN  
    ...
    BEGIN
        ...
        SELECT ''sp_CMP_Update_IQC_Player_Points'', 58, @Start_Dt, @IsError, @Message, @SQL
    END 
END 
ELSE 
BEGIN  
