...
/****** Object:  Job [iQ_Scheduling_sp_CMP_Update_IQC_Player_Ratings_1E6E2FE4_09BD_4E5C_B4E4_22EFD5CAD650]    Script Date: 1/3/2023 4:28:08 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 1/3/2023 4:28:08 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'iQ_Scheduling_sp_CMP_Update_IQC_Player_Ratings_1E6E2FE4_09BD_4E5C_B4E4_22EFD5CAD650', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Parallel_Execution_Command_1]    Script Date: 1/3/2023 4:28:08 PM ******/
...
BEGIN TRY
    SET @SQL = ''Exec [iQ-Gaming].[VCR].[sp_CMP_Update_IQC_Player_Ratings] '';
...
BEGIN  
    ...
    BEGIN
        ...
        SELECT ''sp_CMP_Update_IQC_Player_Ratings'', 18, @Start_Dt, @IsError, @Message, @SQL
    END 
END 
ELSE 
BEGIN  
