...
/****** Object:  Job [iQ_Scheduling_sp_SDS_Update_IQC_Slot_Accounting_7B6F78E2_E378_4D61_BFE1_BF0D51692103]    Script Date: 1/3/2023 4:36:17 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 1/3/2023 4:36:17 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'iQ_Scheduling_sp_SDS_Update_IQC_Slot_Accounting_7B6F78E2_E378_4D61_BFE1_BF0D51692103', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Parallel_Execution_Command_1]    Script Date: 1/3/2023 4:36:17 PM ******/
...
BEGIN TRY
    SET @SQL = ''Exec [iQ-Gaming].[VCR].[sp_SDS_Update_IQC_Slot_Accounting] '';
...
BEGIN  
    ...
    BEGIN
        ...
        SELECT ''sp_SDS_Update_IQC_Slot_Accounting'', 26, @Start_Dt, @IsError, @Message, @SQL
    END 
END 
ELSE 
BEGIN  
