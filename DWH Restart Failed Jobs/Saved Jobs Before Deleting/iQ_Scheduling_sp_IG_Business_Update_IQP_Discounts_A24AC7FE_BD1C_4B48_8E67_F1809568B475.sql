...
/****** Object:  Job [iQ_Scheduling_sp_IG_Business_Update_IQP_Discounts_A24AC7FE_BD1C_4B48_8E67_F1809568B475]    Script Date: 1/3/2023 4:32:57 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 1/3/2023 4:32:57 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'iQ_Scheduling_sp_IG_Business_Update_IQP_Discounts_A24AC7FE_BD1C_4B48_8E67_F1809568B475', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Parallel_Execution_Command_1]    Script Date: 1/3/2023 4:32:57 PM ******/
...
BEGIN TRY
    SET @SQL = ''Exec [iQ-Gaming].[InfoG_4_5].[sp_IG_Business_Update_IQP_Discounts] '';
...
BEGIN  
    ...
    BEGIN
        ...
        SELECT ''sp_IG_Business_Update_IQP_Discounts'', 46, @Start_Dt, @IsError, @Message, @SQL
    END 
END 
ELSE 
BEGIN  
