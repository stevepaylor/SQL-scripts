...
/****** Object:  Job [iQ_Scheduling_sp_CMP_Update_IQC_Player_Ticketstubs_F30FE660_A405_4D3C_B5AB_A5FDC8AD587E]    Script Date: 1/3/2023 4:30:18 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 1/3/2023 4:30:18 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'iQ_Scheduling_sp_CMP_Update_IQC_Player_Ticketstubs_F30FE660_A405_4D3C_B5AB_A5FDC8AD587E', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Parallel_Execution_Command_1]    Script Date: 1/3/2023 4:30:18 PM ******/
...
BEGIN TRY
    SET @SQL = ''Exec [iQ-Gaming].[VCR].[sp_CMP_Update_IQC_Player_Ticketstubs] '';
...
BEGIN  
    ...
    BEGIN
        ...
        SELECT ''sp_CMP_Update_IQC_Player_Ticketstubs'', 59, @Start_Dt, @IsError, @Message, @SQL
    END 
END 
ELSE 
BEGIN  
