...
/****** Object:  LinkedServer [CASIVC07PR]    Script Date: 11/24/2017 1:51:54 PM ******/
EXEC master.dbo.sp_addlinkedserver @server = N'CASIVC07PR', @srvproduct=N'SQL Server'
 /* For security reasons the linked server remote logins password is changed with ######## */
EXEC master.dbo.sp_addlinkedsrvlogin @rmtsrvname=N'CASIVC07PR',@useself=N'False',@locallogin=NULL,@rmtuser=N'cage_inventory_user2',@rmtpassword='$QLisg00d4U'
...
EXEC master.dbo.sp_serveroption @server=N'CASIVC07PR', @optname=N'remote proc transaction promotion', @optvalue=N'true'
GO
