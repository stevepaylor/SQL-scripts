...
where dbname = 'SPAWIN'
  and loginname not in ('SYS_SPASOFT_','SA','VIEJAS\SQLService1','VIEJAS\iderasvc01','DPA','VIEJAS\ssquare','VIEJAS\spaylor','SpaWinAdmin','VIEJAS\avizcarra','VIEJAS\hmccoy')
  --and hostname NOT IN ('initialize','IDERAP03PR','DBAMDB01UT')
  and loginname not in ('NT AUTHORITY\SYSTEM','NT SERVICE\SQLTELEMETRY','NT SERVICE\SQLSERVERAGENT','NT SERVICE\MSSQLSERVER','initialize','NT AUTHORITY\NETWORK SERVICE','VIEJAS\hsimpson','VIEJAS\SQLService1','VIEJAS\momaction','VIEJAS\iderasvc01','VIEJAS\DDuck') -- MAINTENANCE JOBS DON'T COUNT AS BEING IN USE
