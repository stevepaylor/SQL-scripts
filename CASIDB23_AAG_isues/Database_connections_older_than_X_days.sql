...
--WHERE dbname IN ('MarketingCMPAPI','MarketingCMPAPIQA')
--WHERE dbname IN ('CRManalytics')
--where dbname IN ('OperaData_Temp','OperaDM','vDW','vDW2','vDW3')
--where dbname IN ('OperaData_Temp','OperaDM')
--where dbname IN ('OperaDM')
...
----WHERE dbname LIKE ''
  ...
  --WHERE hostname NOT IN ('initialize','IDERAP01PR','DBAMDB01UT')
    --AND dbname LIKE 'Dis%'
