...
ENCRYPTION BY SERVER CERTIFICATE CMPDBAAG01QA_TDE_Cert ;
GO
...
dek.encryptor_thumbprint = cer.thumbprint
--WHERE 
--db_name(database_id) ='AAGTESTDB'

-------------------------------------------------------------------------------
---- Turn on DTE for the database
-------------------------------------------------------------------------------
ALTER DATABASE AAGTESTDB
SET ENCRYPTION ON;
GO
...
---- THE DATABASE IS NOW READY TO ADD TO THE AAG AS NORMAL
---- THE DATABASE IS NOW READY TO ADD TO THE AAG AS NORMAL
---- THE DATABASE IS NOW READY TO ADD TO THE AAG AS NORMAL