...
, CASE 
--WHEN (CASE WHEN mPCRT.Current_Requal_Tier IS NULL THEN '1'ELSE '0' END) = '1'
  WHEN ISNULL(mPCRT.Current_Requal_Tier,'1') = '1' 
  THEN 'BRONZE'
...
, CASE 
  ...
  THEN 'EARNED'
  ELSE (CASE 
        --WHEN (CASE WHEN mPCRUT.Current_Requal_Upgrade_Tier IS NULL THEN '1' ELSE '0' END) = '1'
...
--AND mPRNR.GamingDt IS NOT NULL

WHERE mPCT.PlayerID = '1426933'

AND mNRD.Requal_Month = '6'
  AND mNRD.Tier_Type = 'New'