...
/****** Object:  StoredProcedure [dbo].[sp_Requal]    Script Date: 8/31/2020 8:26:00 AM ******/
SET ANSI_NULLS ON
GO
...
,DATEADD(MM,- c.Earn_Period_Months - 1,CONVERT(DATE, DATEADD(DD,-DAY(DATEADD (MONTH,6,GETDATE()))+1,DATEADD(MM,6,GETDATE())),102)) AS Current_Requal_Qualification_Period_Start_Date
