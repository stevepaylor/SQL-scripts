...
--select 
--* 
--into StayDWH.dbo.room_move_reasons_Snapshot
...
/****** Object:  Table [dbo].[room_move_reasons_Snapshot]    Script Date: 4/27/2024 2:25:30 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[room_move_reasons_Snapshot](
	[id] [text] NOT NULL,
	[tenant_id] [text] NULL,
