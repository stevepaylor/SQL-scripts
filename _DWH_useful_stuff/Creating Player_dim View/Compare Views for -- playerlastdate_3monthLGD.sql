...
, old.player_id as old_player_id
...
, old.Slot_Theo_3monthLGD as old_Slot_Theo_3monthLGD
, old.playerfirstdate_3monthLGD as old_playerfirstdate_3monthLGD
, old.playerlastdate_3monthLGD as old_playerlastdate_3monthLGD

FROM [iQ-Gaming].[Tableau].[player_dim] new
FULL JOIN MSBIDB02DV.vDW.tableau.player_dim old
ON new.player_id = old.player_id

WHERE new.Slot_Theo_3monthLGD <> old.Slot_Theo_3monthLGD
  AND new.playerlastdate_3monthLGD > '2020-06-01'
  AND new.playerlastdate_3monthLGD <> old.playerlastdate_3monthLGD
...
--, old.Slot_Theo_3monthLGD as old_Slot_Theo_3monthLGD
--, old.playerfirstdate_3monthLGD as old_playerfirstdate_3monthLGD
--, old.playerlastdate_3monthLGD as new_playerlastdate_3monthLGD

--FROM myViejas.player_dim new
--FULL JOIN tableau.player_dim old
--ON new.player_id = old.player_id
