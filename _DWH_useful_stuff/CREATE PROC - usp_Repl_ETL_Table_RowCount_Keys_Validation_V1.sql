...
/****** Object:  StoredProcedure [dbo].[usp_Repl_ETL_Table_RowCount_Keys_Validation_V1]    Script Date: 7/16/2023 5:10:58 AM ******/
DROP PROCEDURE [dbo].[usp_Repl_ETL_Table_RowCount_Keys_Validation_V1]
GO
...
--              validation reports. 
-- =============================================
CREATE PROCEDURE [dbo].[usp_Repl_ETL_Table_RowCount_Keys_Validation_V1]
...
BEGIN
	...
	BEGIN
		...
		'INSERT INTO SystemMaintDB.dbo.Repl_ETL_Table_RowCount_Keys_Validation ' +
		@SelectClause +
