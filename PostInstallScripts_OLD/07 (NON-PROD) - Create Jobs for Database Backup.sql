...
set @BackupDirectoryFULL		= '\\DBAMBK01PR\SQLBackup04_NONPROD' -- Specify the backup root directory for the FULLs. Example: \\sequel\sql_nonprod2
set @BackupDirectoryDIFF		= '\\DBAMBK01PR\SQLBackup04_NONPROD' -- Specify the backup root directory for the DIFFs. Example: \\sequel\sql_nonprod2
set	@BackupDirectoryINCR		= '\\DBAMBK01PR\SQLBackup04_NONPROD' -- Specify the backup root directory for the INCRs. Example: \\sequel\sql_incr   
