...
( NAME = N'DBA_Data', FILENAME = N'K:\UserDBdata\DBA_data.mdf' , SIZE = 102400KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'DBA_Log', FILENAME = N'L:\UserDBlog\DBA_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
END

GO
EXEC dbo.sp_dbcmptlevel @dbname=N'DBA', @new_cmptlevel=100
GO
