...
----------------------------------------------------------------------------------------
IF  EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE routine_name = 'usp_ScriptLogins_DBUsers_Roles' AND ROUTINE_TYPE = 'PROCEDURE')
DROP PROCEDURE usp_ScriptLogins_DBUsers_Roles ;
GO

CREATE PROCEDURE usp_ScriptLogins_DBUsers_Roles
AS
