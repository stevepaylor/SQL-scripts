...
----------------------------------------------------------------------------------------
IF  EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE routine_name = 'usp_ScriptLoginDBUserRoles' AND ROUTINE_TYPE = 'PROCEDURE')
DROP PROCEDURE usp_ScriptLoginDBUserRoles ;
GO

CREATE PROCEDURE usp_ScriptLoginDBUserRoles
AS
