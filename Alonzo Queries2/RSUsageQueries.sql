...
---and TimeStart >='2019-04-11 00:00:00.000' and TimeStart <='2019-04-12 00:00:00.000'
ORDER BY l.TimeStart DESC;


-- Counts by Day
select convert(varchar(10),timestart, 101)
,   count(*)  FROM [ReportServer].[dbo].[ExecutionLog](NOLOCK)
group by convert(varchar(10), timestart, 101)
order by convert(varchar(10), timestart, 101) desc
