...
FROM Viejas_Custom_Processes.dbo.tPlayerEmail_HardBounce_Deletes target
...
, target.[email_bounce_dttm]
, target.mod_TM_Number
, source.TEAM_MEMBER_NUM

FROM Viejas_Custom_Processes.dbo.tPlayerEmail_HardBounce_Deletes target with (nolock)
