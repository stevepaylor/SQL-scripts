...
BEGIN
  ...
  SELECT 'DBA - Backup DIFF (All Databases) 2',
  ...
  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01, OutputFileNamePart02)
  SELECT 'DBA - Backup FULL (All Databases) 2',
  ...
  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01, OutputFileNamePart02)
  SELECT 'DBA - Backup LOG (All Databases) 2',
  ...
  SELECT 'DBA - Integrity Check (All Databases) 2',
         'EXECUTE [dbo].[DatabaseIntegrityCheck]' + CHAR(13) + CHAR(10) + '@Databases = ''ALL_DATABASES' + CASE WHEN @AmazonRDS = 1 THEN ', -rdsadmin' ELSE '' END + ''',' + CHAR(13) + CHAR(10) + '@LogToTable = ''' + @LogToTable + '''',
         @DatabaseName,
         'DatabaseIntegrityCheck'

  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01)
  SELECT 'DBA - Index Optimize (All Databases) 2',
         'EXECUTE [dbo].[IndexOptimize]' + CHAR(13) + CHAR(10) + '@Databases = ''ALL_DATABASES'',' + CHAR(13) + CHAR(10) + '@LogToTable = ''' + @LogToTable + '''',
         @DatabaseName,
         'IndexOptimize'
  ...
  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01)
  SELECT 'DBA - CommandLog Cleanup 2',
  ...
  BEGIN
   UPDATE @Jobs
   SET Selected = 1
   WHERE [Name] IN('DBA - Integrity Check (All Databases) 2','DBA - Index Optimize (All Databases) 2','DBA - CommandLog Cleanup 2')
  END
  ELSE IF SERVERPROPERTY('EngineEdition') = 8
  BEGIN
   UPDATE @Jobs
   SET Selected = 1
   WHERE [Name] IN('DBA - Integrity Check (All Databases) 2','DBA - Index Optimize (All Databases) 2','DBA - CommandLog Cleanup 2','sp_delete_backuphistory','sp_purge_jobhistory')
  END
