TRUNCATE TABLE OperaDM.dbo.FINANCIAL_TRANSACTIONS
GO

INSERT INTO OperaDM.dbo.FINANCIAL_TRANSACTIONS
...
FROM [CASIDB23BPR].[Opera_Extract].dbo.[FINANCIAL_TRANSACTIONS]
