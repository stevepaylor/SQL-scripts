...
DROP TABLE IF EXISTS Hotel.Stay_Reservations_STAGE
GO
...
CREATE TABLE Hotel.Stay_Reservations_STAGE(
 ...
 CONSTRAINT PK_Stay_Reservations_STAGE_id PRIMARY KEY CLUSTERED 
(
	id ASC
