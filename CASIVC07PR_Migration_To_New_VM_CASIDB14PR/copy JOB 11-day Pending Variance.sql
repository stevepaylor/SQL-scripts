...
/****** Object:  Job [11-day Pending Variance]    Script Date: 11/29/2017 11:21:11 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Variance Jobs]    Script Date: 11/29/2017 11:21:11 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'11-day Pending Variance', 
		@enabled=1, 
		...
		@notify_level_page=2, 
		@delete_level=0, 
		@description=N'E-mails out a list of variances that have passed their 11-days past GL date to the appropriate team members.', 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Nightly check.]    Script Date: 11/29/2017 11:21:11 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Nightly check.', 
		...
		@command=N'EXEC CASH_VARIANCE.dbo.p_pending_variances_timeline_alert 11', 
