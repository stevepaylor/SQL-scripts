...
/****** Object:  Job [7-day Pending Variance]    Script Date: 11/29/2017 11:23:54 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Variance Jobs]    Script Date: 11/29/2017 11:23:54 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Nightly check.]    Script Date: 11/29/2017 11:23:54 AM ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Nightly at Midnight', 
		...
		@schedule_uid=N'cbe88e6c-8521-4bf3-b6f4-9ea4be581822'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
