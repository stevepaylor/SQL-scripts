...
WHERE display_date >= ''2025-03-01''::date
'
) ;
...
FROM [StayDWH].[dbo].[line_items_0301_PLUS] delta
...
----06/01+++ (prod)
--(201174 rows affected)
--(25236 rows affected)

----06/01+++ (prod) - second run on 8/6
--(203116 rows affected)
--(1438 rows affected)