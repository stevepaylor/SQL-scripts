...
/****** Object:  Job [AAA]    Script Date: 10/9/2025 4:09:17 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 10/9/2025 4:09:17 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'AAA', 
		@enabled=1, 
		...
		@owner_login_name=N'VIEJAS\spaylor', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [2021]    Script Date: 10/9/2025 4:09:17 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'2021', 
		@step_id=1, 
...
DROP TABLE IF EXISTS Opera_5_0.FINANCIAL_TRANSACTIONS_stage_2021 ;

DECLARE @startDate char(19) = ''2021-01-01 00:00:00'' ;
DECLARE @endDate char(19) = ''2021-12-31 23:59:59'' ;

PRINT ''@startDate = '' + @startDate ;
PRINT ''@endDate = '' + @endDate ;

SELECT * 
INTO Opera_5_0.FINANCIAL_TRANSACTIONS_stage_2021 
...
ALTER TABLE [Opera_5_0].[FINANCIAL_TRANSACTIONS_stage_2021] ADD  CONSTRAINT [PK_FINANCIAL_TRANSACTIONS_stage_2021] PRIMARY KEY CLUSTERED 
(
	[TRX_NO] ASC
...
USING Opera_5_0.FINANCIAL_TRANSACTIONS_stage_2021 AS stg
...
,  CAST(stg.QUANTITY_CODE as varchar(40))
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [2022]    Script Date: 10/9/2025 4:09:17 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'2022', 
		@step_id=2, 
		@cmdexec_success_code=0, 
		@on_success_action=3, 
		@on_success_step_id=0, 
...
DROP TABLE IF EXISTS Opera_5_0.FINANCIAL_TRANSACTIONS_stage_2022 ;

DECLARE @startDate char(19) = ''2022-01-01 00:00:00'' ;
DECLARE @endDate char(19) = ''2022-12-31 23:59:59'' ;

PRINT ''@startDate = '' + @startDate ;
PRINT ''@endDate = '' + @endDate ;

SELECT * 
INTO Opera_5_0.FINANCIAL_TRANSACTIONS_stage_2022 
FROM OPERA..OPERA.FINANCIAL_TRANSACTIONS_VIEW 
WHERE INSERT_DATE BETWEEN @startDate AND @endDate
ORDER BY TRX_NO ;
...
ALTER TABLE [Opera_5_0].[FINANCIAL_TRANSACTIONS_stage_2022] ADD  CONSTRAINT [PK_FINANCIAL_TRANSACTIONS_stage_2022] PRIMARY KEY CLUSTERED 
(
	[TRX_NO] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
...
MERGE Opera_5_0.FINANCIAL_TRANSACTIONS AS tgt
USING Opera_5_0.FINANCIAL_TRANSACTIONS_stage_2022 AS stg
ON tgt.TRX_NO = stg.TRX_NO
...
,  CAST(stg.QUANTITY_CODE as varchar(40))
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [2023]    Script Date: 10/9/2025 4:09:17 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'2023', 
		@step_id=3, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_success_step_id=0, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'ONCE AT 10:30PM', 
		@enabled=0, 
		@freq_type=1, 
		@freq_interval=0, 
		@freq_subday_type=0, 
		...
		@schedule_uid=N'6d2285a8-ff86-40f4-90c4-7b803ecd2995'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
