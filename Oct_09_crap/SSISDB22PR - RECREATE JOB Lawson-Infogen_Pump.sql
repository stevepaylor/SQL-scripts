...
/****** Object:  Job [Lawson-Infogen_Pump]    Script Date: 10/10/2025 4:23:03 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 10/10/2025 4:23:03 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Lawson-Infogen_Pump', 
		@enabled=0, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [SSIS: Infogen_Pump]    Script Date: 10/10/2025 4:23:03 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'SSIS: Infogen_Pump', 
		...
		@command=N'/SQL "\"\Lawson\Infogen_Pump\"" /SERVER SSISDB22PR /CHECKPOINTING OFF /REPORTING E', 
